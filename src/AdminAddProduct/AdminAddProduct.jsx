...
export default function AdminPanel() {
  ...
  const availableSizes = form.category
    ? categoriesConfig[form.category].sizes
    : []
  const availableSubcategories = form.category
    ? categoriesConfig[form.category].subcategories
    : []
      ...
      {tab === 'add' && (
        <form className="admin-form" onSubmit={handleSubmit}>
          ...
          <div className="image-upload">
            ...
            {!preview &&
              form.image && ( // Показываем уже загруженное изображение при редактировании/просмотре
                <img
                  src={form.image}
          ...
          <input
            ...
            value={form.rating}
            onChange={handleChange}
            placeholder="Оценка (например, 4.5)"
            min="0"
            max="5"
          />
          <textarea
