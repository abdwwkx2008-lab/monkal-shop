...
const Favorites = () => {
  ...
  const handleClearAll = () => {
    if (
      window.confirm('Вы уверены, что хотите полностью очистить избранное?')
    ) {
      clearFavorites()
    }
  }
      ...
      <div className="empty-favorites-container">
        <div className="empty-favorites-content">
          ...
          <p className="empty-favorites-text">
            Нажмите на звездочку, чтобы сохранить самое лучшее.
          </p>
      ...
      <div className="favorites-container">
        <div className="favorites-header">
          ...
          <div className="favorites-actions">
            ...
            <button onClick={handleClearAll} className="clear-favorites-button">
              Очистить избранное
            </button>
          </div>
        </div>
