                ...
                <div className="about-box">
                    ...
                    <div className="about-cart-1">
                        ...
                        <p className="about-text">
                            ...
                            Удобный сайт, где вы можете оформить заказ без необходимости скачивать китайское <br/>
                            приложение Pinduoduo, с удобной фильтрацией огромного ассортимента и мгновенным отображением <br/>
                    ...
                    <div className="about-cart-2">
                        ...
                        <div className="feature-item">
                            ...
                            <div className="text-content">
                                ...
                                <p className="about-text-small">Мы тщательно проверяем каждый товар на наличие брака перед отправкой.</p>
                            </div>
                        </div>
                        ...
                        <div className="feature-item">
                            ...
                            <div className="text-content">
                                ...
                                <p className="about-text-small">Только оригинальные и качественные товары с Pinduoduo.</p>
                            </div>
                        </div>
